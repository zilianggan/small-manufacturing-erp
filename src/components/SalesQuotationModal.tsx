  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-slate-900/60 backdrop-blur-sm overflow-y-auto print:p-0 print:bg-white print:static">
      ...
      >
        ...
        <div className="p-8 space-y-8 text-xs text-slate-600 print:p-0 font-sans bg-white flex-1 min-h-0 overflow-y-auto print:overflow-visible print:h-auto" id="printable-sales-quotation-sheet">
